...
const variants: Record<Variant, string> = {
  primary:
    "rounded-full text-white bg-gradient-to-b from-[#f2679e] to-[#d63f7c] ring-1 ring-[#c93a72]/60 shadow-[inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_2px_rgba(122,20,58,0.35),0_2px_10px_-2px_rgba(234,76,137,0.5)] hover:from-[#f47bab] hover:to-[#e04a86] active:scale-[0.98] disabled:opacity-60 disabled:active:scale-100",
